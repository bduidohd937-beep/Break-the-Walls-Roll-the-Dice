...
export const HEROES: UnitDef[] = [
  ...
  { id: "shield", name: "철갑 방패병", sprite: "🛡️", element: "neutral", hp: 260, atk: 22, speed: 30, range: 32, attackInterval: 1.3, cost: 150, cooldown: 6, role: "탱커", ability: "guard", abilityValue: 0.22 },
  ...
  { id: "paladin", name: "성기사", sprite: "🧝", element: "dark", hp: 620, atk: 72, speed: 26, range: 42, attackInterval: 1.7, cost: 700, cooldown: 15, role: "탱커", ability: "regen", abilityValue: 0.018 },
  { id: "assassin", name: "암살자", sprite: "🥷", element: "dark", hp: 210, atk: 145, speed: 64, range: 45, attackInterval: 1.8, cost: 900, cooldown: 18, role: "암살자", ability: "crit", abilityValue: 0.28 },
  ...
  { id: "arthur", name: "아서왕", sprite: "👑", element: "dark", hp: 2100, atk: 330, speed: 25, range: 55, attackInterval: 2.6, cost: 3000, cooldown: 40, role: "전설", ability: "execute", abilityValue: 0.25 },
];
...
export const ENEMIES: UnitDef[] = [
  ...
  { id: "fireOgreE", name: "화염의 거인 오거", sprite: "👹", element: "fire", hp: 1200, atk: 180, speed: 18, range: 55, attackInterval: 2.5, cost: 0, cooldown: 0, role: "강적", attackType: "splash", splashRadius: 10 },
];
